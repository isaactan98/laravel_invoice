    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-input id="website" class="block mt-1 w-full" type="text" name="website" required />
            </div>

            <!--  -->
            <div class="mt-4">
                <x-label for="bankName" :value="__('Bank Name')" />
                <x-input id="bankName" class="block mt-1 w-full" type="text" name="bankName" required />
            </div>

            <!--  -->
            <div class="mt-4">
                <x-label for="bankAcc" :value="__('Bank Account')" />
                <x-input id="bankAcc" class="block mt-1 w-full" type="text" name="bankAcc" required />
            </div>
